...
namespace StansAssets.Build.Editor
{
    ...
    class SettingsTab : BaseTab, IBuildSystemWindowTab
    {
        ...
        public SettingsTab()
            ...
            var testIncrement = this.Q<Button>("test-increment");
            testIncrement.clicked += OnTestIncrementClick;

            BindVersionIncrementSection();
        }

        private void OnTestIncrementClick() {
            var metadata = Meta.Build.Metadata;
            IncrementBuildNumber.Increment(metadata, EditorUserBuildSettings.activeBuildTarget);
        }
